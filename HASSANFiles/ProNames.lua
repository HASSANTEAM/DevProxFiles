...
if Manager(msg) then
if DevAbs:get(HASSAN.."Abs:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevAbs:set(HASSAN.."Abs:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevAbs:set(HASSAN.."Abs:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbs:get(HASSAN.."Abs:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbs:get(HASSAN.."Abs:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbs:get(HASSAN.."Abs:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbs:get(HASSAN.."Abs:Lock:ProNames"..msg.chat_id_) and DevAbs:get(HASSAN.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbs:get(HASSAN.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbs:srem(HASSAN..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbs:get(HASSAN.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbs:get(HASSAN.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
DevAbs:del(HASSAN.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAbs:set(HASSAN.."Abs:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAbs:del(HASSAN.."Abs:Lock:ProNames"..msg.chat_id_)
end
end
